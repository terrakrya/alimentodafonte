			...
			this.form.forEach((item, index) => {
				...
				axios({
					...
					if (collectors_group && collectors_group._id) {
						this.import_log.push({status: 'success', message: (index + ' - ' + collectors_group.name + ': cadastrada com sucesso'), index: index})
					} else {
						this.import_log.push({status: 'success', message: (index + ' - Erro: '+collectors_group), index: index})
